    ...
    public partial class INITIAL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSubjectGrades", x => new { x.StudentID, x.TeacherSubjectID });
                    table.ForeignKey(
                        name: "FK_StudentSubjectGrades_Student_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Student",
                        principalColumn: "StudentID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSubjectGrades_TeacherSubjects_TeacherSubjectID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectGrades_TeacherSubjectID",
